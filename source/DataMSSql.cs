...
namespace LAMSoft.WebServices
{
	...
	/// </summary>
	public class DataMSSql : LAMSoft.WebServices.DataGen
	{
		...
		public override string ConnectionString
		{
			get
			{
				if(this.m_ConnectionString.Length==0)
				{
					...
					if(Settings.dbServerType.ToUpper()!=Settings.DataServerTypes.MSSql.ToString().ToUpper())
					{
					...
					mCadena.Append("Server=" + Settings.dbServerName + "," + Settings.dbServerTCPPort + ";");
					mCadena.Append("Database=" + Settings.dbName + ";");
					mCadena.Append("User id=" + Settings.dbUserName + ";");
					mCadena.Append("Password=" + Settings.dbUserPass + ";");
					mCadena.Append("persist security info=" + Settings.dbPersistSegInfo + ";");
					mCadena.Append("Pooling=" + Settings.dbPooling + ";");
					mCadena.Append("Min Pool Size=" + Settings.dbMinPoolSize + ";");
					mCadena.Append("Max Pool Size=" + Settings.dbMaxPoolSize + ";");
					mCadena.Append("Application Name=" + Settings.ServiceShortName + ";");
