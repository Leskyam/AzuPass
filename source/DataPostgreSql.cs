...
namespace LAMSoft.WebServices
{
	...
	/// </summary>
	public class DataPostgreSQL : LAMSoft.WebServices.DataGen
	{
		...
		public override string ConnectionString
		{
			get
			{
				if(this.m_ConnectionString.Length==0)
				{
					...
					if(Settings.dbServerType.ToUpper()!=Settings.DataServerTypes.PostgreSQL.ToString().ToUpper())
					{
					...
					mCadena.Append("Server=" + Settings.dbServerName + ";");
					mCadena.Append("Port=" + Settings.dbServerTCPPort + ";");
