  ...
  public class Settings
  {
    ...
    public static string ServiceShortName
    {
      get
      {
        ...
        {
          m_ServiceShortName = Settings.getWebConfigSimpleValue("ServiceShortName");
    ...
    public static string ServiceFullName
    {
      get
      {
        ...
        {
          m_ServiceFullName = Settings.getWebConfigSimpleValue("ServiceFullName");
    ...
    public static bool CheckClientAppsURL
    {
      get
      {
        try
        {
          m_CheckClientAppsURL = System.Convert.ToBoolean(Settings.getWebConfigSimpleValue("CheckClientAppsURL"));
    ...
    public static int MonthBeforeReCheck
    {
      get
      {
        try
        {
          m_MonthBeforeReCheck = System.Convert.ToInt32(Settings.getWebConfigSimpleValue("MonthBeforeReCheck"));
    ...
    private static System.Uri proxyAddress
    {
      get
      {
        ...
        try
        {
          m_proxyAddress = new Uri(Settings.getWebConfigSimpleValue("proxyAddress"));
    ...
    private static string NetBIOSDomain
    {
      get
      {
        ...
        try
        {
          m_NetBIOSDomain = Settings.getWebConfigSimpleValue("NetBIOSDomain");
    ...
    private static string proxyUser
    {
      get
      {
        ...
        try
        {
          m_proxyUser = Settings.getWebConfigSimpleValue("proxyUser");
          return m_proxyUser;
        }
        catch (System.Exception Ex)
        {
    ...
    private static string proxyPasswd
    {
      get
      {
        ...
        try
        {
          m_proxyPasswd = Settings.getWebConfigSimpleValue("proxyPasswd");
    ...
    public static string AzuPassProfileMgrURL
    {
      get
      {
        ...
        {
          m_AzuPassProfileMgrURL = Settings.getWebConfigSimpleValue("AzuPassProfileMgrURL").Trim();
    ...
    public static string dbServerName
    {
      get
      {
        ...
        {
          m_dbServerName = Settings.getWebConfigSimpleValue("dbServerName");
